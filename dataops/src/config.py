"""Carregamento e validação das variáveis de ambiente do módulo DataOps."""
...
class Config:
    """Configurações do DataOps carregadas do .env."""
...
def carregar_config() -> Config:
    ...
    return Config(
        ...
        kafka_topic_raw=os.environ["KAFKA_TOPIC_RAW"],
        pncp_base_url=os.environ["PNCP_BASE_URL"].rstrip("/"),
